...
function Entity:CPPIGetOwner()
	...
	if (!Player or !Player:IsValid()) then return nil, CPPI_NOTIMPLEMENTED end
...
if (SERVER) then
	function Entity:CPPISetOwner(ply)
		if (!ply or !ply:IsValid() or !ply:IsPlayer()) then return false end
	...
	function Entity:CPPICanTool(ply, toolmode)
		if (!ply or !ply:IsValid() or !ply:IsPlayer() or !toolmode) then return false end
