...
function SPropProtection.SpawnMenuOpen()
	if (SPropProtection.AdminCPanel) then SPropProtection.AdminPanel(SPropProtection.AdminCPanel) end
	if (SPropProtection.ClientCPanel) then SPropProtection.ClientPanel(SPropProtection.ClientCPanel) end
end
...
function SPropProtection.PopulateToolMenu()
	spawnmenu.AddToolMenuOption("Tools", "Simple Prop Protection", "Admin", "Admin", "", "", SPropProtection.AdminPanel)
	spawnmenu.AddToolMenuOption("Tools", "Simple Prop Protection", "Client", "Client", "", "", SPropProtection.ClientPanel)
end
