GM.Version = "2.4.2"
GM.Name = "CustomRP "..GM.Version
GM.Author = "By Vlad, Gred"
...
for k,v in pairs(file.Find("..materials/models/nater/*")) do
	resource.AddFile("materials/models/nater/"..v)
end

for k,v in pairs(file.Find("..models/nater/*")) do
	resource.AddFile("models/nater/"..v)
end


resource.AddFile("models/nater/*")
resource.AddFile("materials/models/nater/*")
